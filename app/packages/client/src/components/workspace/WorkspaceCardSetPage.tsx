...
function WorkspaceCardSetPage() {
    ...
    return <Container>
        ...
        {state.workspaceCardSet.cardsLoading ? <div>Loading cards...</div> : <CardList cardIdsBeingDeleted={state.workspaceCardSet.cardIdsBeingDeleted} onDeleteCard={card => actions.workspaceCardSet.deleteCard(card)} cards={state.workspaceCardSet.cards}/>}
